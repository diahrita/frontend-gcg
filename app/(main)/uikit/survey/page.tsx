            ...
            <div className="col-12">
                <div className="card">
                    ...
                    >
                        ...
                        <Column field="name" header="Email" sortable body={nameBodyTemplate} headerStyle={{ minWidth: '15rem' }}></Column>
                        <Column field="name" header="Password" sortable body={nameBodyTemplate} headerStyle={{ minWidth: '15rem' }}></Column>
